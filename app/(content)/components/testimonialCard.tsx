...
export default function TestimonialCard({
  ...
  return (
    <a
      href="#"
      className="flex flex-col md:flex-row items-center bg-white border border-white shadow-sm hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 max-w-[200px] overflow-hidden"
    >
